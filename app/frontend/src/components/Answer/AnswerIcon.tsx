...
export const AnswerIcon: React.FC<AnswerIconProps> = ({ approach }) => {
    if (approach == Approaches.ChatWebRetrieveRead) {
        ...
        return <div className={styles.answerLogoWork}><BuildingMultiple24Filled primaryFill={"rgba(27, 74, 239, 1)"} aria-hidden="true" aria-label="Work Answer logo" /> Search Past TCOTs</div>;
        }
